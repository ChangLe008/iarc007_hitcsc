...
//! namespace
/*! localization algorithm of robot for iarc007
*
*/
namespace localization{
//! class
/*! Gaussian filter for smoothing image
*
*/
class Gaussian {
public:
...
//! class
/*! segment of lines(a group of pixels with the same gradient)
*
*/
class Segment {
public:
...
public:
	...
	//! ( A point the line passes through; when normalized, 
	/*! it is the point closest to the origin (hence perpendicular to the line)
	*/
...
public:
	...
	*/
	...
	std::vector<std::pair<float,float>> extractTags(cv::Mat& image,int minimumSegmentSize, float minimumLineLength);
} // namespace

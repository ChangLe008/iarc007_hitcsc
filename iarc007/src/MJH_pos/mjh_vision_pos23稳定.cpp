...
float  y[23]={-0.5125,0,1.085,2.17,3.255,4.34,5.425,6.51,7.595,8.68,9.765,10.85,11.935,13.02,14.105,15.19,16.275,17.36,18.445,19.53,20.615,21.70,22.2125};//xin sia cahng
float  x[23]={-0.56,0,1.1075,2.2025,3.2975,4.3925,5.4875,6.5825,7.6775,8.7725,9.8675,10.9775,12.0875,13.1825,14.2775,15.3725,16.4675,17.5625,18.6575,19.7525,20.8475,21.955,22.515};//xin sai chang
...
//**************************************************8
                ...
                cv::threshold(V_image, V_image, 135, 1, cv::THRESH_BINARY);
                        ...
                        for(int i=0;i<x_lines.size()-1;i++)
                        {
                            ...
                            for (int j=i+1;j<x_lines.size();j++)
                            {
                                ...
                                if(fabs(fabs(first-second)-0.54)<0.15)
                                {
                                    ...
                                    //h//////////////////////////************************
                                    else if ((fabs(midl - x_0) >= 3) && (fabs(midl - x_0) <= 6))  //acceptable deviation:20-6
                                    {
                                        if (midl - x_0 < 0)
                                        {
                                            boundary_x += xxw_cali;
                                    ...
                                    else if ((fabs(midl - x_20) >= 3) && (fabs(midl - x_20) <= 6))
                                    {
                                        if (midl - x_20 < 0)
                                        {
                                            boundary_x += xxw_cali;
                        ...
                        for(int i=0;i<y_lines.size()-1;i++)
                        {
                            ...
                            for (int j=i+1;j<y_lines.size();j++)
                            {
                                ...
                                if(fabs(fabs(first-second)-0.5)<0.15)
                                {
                                    ...
                                    //h////////////////////
                                    else if ((fabs(midl - y_0) >= 3) && (fabs(midl - y_0) <= 6))
                                    {
                                        if (midl - y_0 < 0)
                                        {
                                            boundary_y += xxw_cali;
                                    ...
                                    else if ((fabs(midl - y_20) >= 3) && (fabs(midl - y_20) <= 6))
                                    {
                                        if (midl - y_20 < 0)
                                        {
                                            boundary_y += xxw_cali;

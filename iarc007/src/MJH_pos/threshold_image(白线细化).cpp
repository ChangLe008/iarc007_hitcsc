...
void ColorBinary(const Mat &ImageSource, Mat &ImageBinary)
{
	Mat ImageHSV;
...
void ThresholdImage(const Mat &ImageSource, Mat &ImageBinary, int ThinTime)
{
	Mat ImageWhiteBinary;
	WhiteBinary(ImageSource, ImageWhiteBinary, ThinTime);
	Mat ImageColorBinary = Mat::zeros(ImageSource.rows, ImageSource.cols, CV_8UC1);
	ColorBinary(ImageSource, ImageColorBinary);
	
	ImageBinary = ImageWhiteBinary + ImageColorBinary;
	Mat ImageThin;

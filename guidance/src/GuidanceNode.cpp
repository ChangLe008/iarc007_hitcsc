...
//VideoWriter writer1("src/iarc007/doc/left_image.avi", CV_FOURCC('M', 'J', 'P', 'G'), 5.0, Size(320, 240),0);
//VideoWriter writer2("src/iarc007/doc/right_image.avi", CV_FOURCC('M', 'J', 'P', 'G'), 5.0, Size(320, 240),0);
//VideoWriter writer3("src/iarc/depth_image.avi", CV_FOURCC('M', 'J', 'P', 'G'), 5.0, depth8.size(),0);
...
//writer1 << g_greyscale_image_left ;	
...
//writer2 << g_greyscale_image_right;			
